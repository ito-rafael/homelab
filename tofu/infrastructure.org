...
|---------------+-------------+------+----------------+--------------+-----------------------------------------|
| Headscale VPN | Headscale   | LXC  | Debian 13      | local:vztmpl | debian-13-standard_13.6-1_amd64.tar.zst |
| VyOS Router   | VyOS        | VM   | VyOS 1.5 QCOW2 | local:iso    | build from rolling @ 18a550b7 commit    |
|---------------+-------------+------+----------------+--------------+-----------------------------------------|
